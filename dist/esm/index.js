  ...
  function BucketAggregationValues(props) {
    ...
    _this.getChildAggCmps = function (bucket, selectedFilters) {
      ...
      if (hasChildAggregation) {
        ...
        return React.createElement(BucketAggregationValues, {
    ...
    _this._renderContainerElement = function (valuesCmp) {
      return React.createElement(List, null, valuesCmp);
    };
...
function (_Component) {
  ...
  function BucketAggregation(props) {
    ...
    _this._renderElement = function (title, containerCmp) {
      return containerCmp ? React.createElement(Card, null, React.createElement(Card.Content, null, React.createElement(Card.Header, null, title)), React.createElement(Card.Content, null, containerCmp)) : null;
    };
...
function (_Component) {
  ...
  _createClass(AutocompleteSearchBar, [{
    ...
    value: function _renderSuggestions(querySuggestions) {
      ...
      return React.createElement("ul", null, querySuggestions.map(function (text) {
...
var AutocompleteSearchBarUncontrolled = function AutocompleteSearchBarUncontrolled(props) {
  return React.createElement(AutocompleteSearchBar, Object.assign({
...
function (_Component) {
  ...
  _createClass(ShouldRender, [{
    ...
    value: function render() {
      ...
      return condition ? React.createElement(Fragment, null, this.props.children) : null;
    }
  }]);
  ...
  function EmptyResults(props) {
    ...
    _this._renderElement = function (queryString, resetQuery) {
      return React.createElement(Segment, {
        ...
        name: "search"
      }), "No results found!"), React.createElement("em", null, "Current search \"", queryString, "\""), React.createElement("br", null), React.createElement(Button, {
        primary: true,
        onClick: function onClick() {
          return resetQuery();
        }
...
function (_Component) {
  ...
  function Error(props) {
    ...
    _this._renderElement = function (error) {
      return React.createElement("div", null, "Oups! Something went wrong while fetching results.");
    };
  ...
  _createClass(Error, [{
    ...
    value: function render() {
      ...
      }, React.createElement(Fragment, null, this.renderElement(error)));
    }
  }]);
...
function (_Component) {
  ...
  function Pagination(props) {
    ...
    _this._renderElement = function (currentPage, currentSize, totalResults, onPageChange, options) {
      ...
      return React.createElement(Pagination$2, Object.assign({
  ...
  _createClass(ReactSearchKit, [{
    ...
    value: function render() {
      ...
      return React.createElement(Provider, {
        store: this.store
      }, React.createElement(Bootstrap$1, {
...
function (_Component) {
  ...
  _createClass(ResultsGrid, [{
    ...
    value: function _renderGridItem(result, index) {
      ...
      }), React.createElement(Card.Content, null, React.createElement(Card.Header, null, result.title), React.createElement(Card.Description, null, result.description)));
    }
  }, {
    key: "_renderElement",
  ...
  _createClass(ResultsList, [{
    ...
    value: function _renderListItem(result, index) {
      return React.createElement(Item, {
        ...
        size: "small",
        src: result.imgSrc || 'http://placehold.it/200'
      }), React.createElement(Item.Content, null, React.createElement(Item.Header, null, result.title), React.createElement(Item.Description, null, result.description)));
    }
  }, {
    key: "_renderElement",
...
function (_Component) {
  ...
  function ResultsMultiLayout(props) {
    ...
    _this._renderElement = function (layout) {
      return layout === 'list' ? React.createElement(_this2.ResultsListCmp, null) : React.createElement(_this2.ResultsGridCmp, null);
    };
